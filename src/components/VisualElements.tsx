...
export function RedactedStamp({
  ...
  return (
    <div
      className={`redacted-stamp ${className}`}
      style={{
        position: 'relative',
    ...
    >
      ...
      <div
        style={{
          ...
          bottom: 0,
          background: `
            radial-gradient(circle at 20% 30%, rgba(180, 35, 45, 0.1) 0%, transparent 50%),
            radial-gradient(circle at 80% 70%, rgba(180, 35, 45, 0.1) 0%, transparent 50%)
          `,
          borderRadius: 'var(--radius-lg)',
          pointerEvents: 'none',
        }}
...
export function ClassifiedWatermark({
  ...
  return (
    <div
      className={`classified-watermark ${className}`}
      style={{
        position: 'absolute',
        top: '50%',
        left: '50%',
        ...
        color: `rgba(180, 35, 45, ${opacity})`,
        pointerEvents: 'none',
        userSelect: 'none',
        zIndex: 1,
        fontFamily: 'var(--font-family-display)',
        letterSpacing: '0.1em',
        textShadow: `0 0 20px rgba(180, 35, 45, ${opacity * 2})`,
      }}
    >
      {text}
    </div>
...
interface SecurityBadgeProps {
  level: 'public' | 'classified' | 'secret' | 'top-secret';
  className?: string;
}
        ...
        style={{
          ...
          background: `
            repeating-linear-gradient(
              ...
              transparent,
              transparent 4px,
              rgba(180, 35, 45, ${opacity}) 4px,
              rgba(180, 35, 45, ${opacity}) ${4 + parseInt(height)}px
            )
          `,
          pointerEvents: 'none',
          zIndex: 1,
    ...
    >
      ...
      <div
        style={{
          ...
          bottom: 0,
          background: `
            radial-gradient(circle at 20% 50%, rgba(180, 35, 45, ${opacity}) 0%, transparent 50%),
            radial-gradient(circle at 80% 20%, rgba(180, 35, 45, ${opacity}) 0%, transparent 50%),
            radial-gradient(circle at 40% 80%, rgba(180, 35, 45, ${opacity}) 0%, transparent 50%),
            radial-gradient(circle at 60% 40%, rgba(180, 35, 45, ${opacity}) 0%, transparent 50%)
          `,
          pointerEvents: 'none',
          zIndex: 1,
        }}
